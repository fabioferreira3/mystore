...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format("Por favor digite não mais do que {0} caracteres."),
		minlength: $.validator.format("Por favor digite pelo menos {0} caracteres."),
		rangelength: $.validator.format("Por favor digite um valor entre {0} e {1} caracteres de tamanho."),
