...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/UploadHandler.php',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/images/catalog/' . $_SESSION['product']['productId'] . '/',
            'upload_url' => $this->get_full_url().'/images/catalog/' . $_SESSION['product']['productId'] . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0777,
            'param_name' => 'files',
